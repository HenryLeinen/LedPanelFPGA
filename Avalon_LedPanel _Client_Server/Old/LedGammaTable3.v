...
module GammaTable #(
		...
		input  wire [3*COLOR_BITS_OUT-1:0] rgb3_out                 //             .rgb_out
	);
	...
	assign red3_in = rgb3_in[COLOR_BITS-1:0];
	assign green3_in = rgb3_in[2*COLOR_BITS-1:COLOR_BITS];
	assign blue3_in = rgb3_in[3*COLOR_BITS-1:2*COLOR_BITS];
